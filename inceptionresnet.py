# Dan: Full credit to R4j4n @ GitHub

from tensorflow.keras.layers import Conv2D, Activation, Input, MaxPooling2D, Dense, Dropout, \
...
if __name__ == "__main__":
    ...
    print(f'Model loaded successfully using {path} weights')